...
import {postgresPool} from "./infrastructure/postgres/pool";
import {EnvVariables, startServer} from "./web/app_new";
...
const pool: Pool = postgresPool(pgConfig);
export const server = startServer(envVars)(pool);
